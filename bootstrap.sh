...
if test "${METWORK_PROFILE_LOADED:-0}" = "1"; then
    ...
    MFSYSMON_VERSION=$("${MFEXT_HOME}/bin/guess_version.sh")
    export MFSYSMON_VERSION
...
echo "export MODULE_VERSION := ${MFSYSMON_VERSION}" >>adm/root.mk
...
echo "endif" >>adm/root.mk
        ...
        echo "export MFCOM_VERSION := ${MFCOM_VERSION}" >>adm/root.mk
            ...
            echo "export ${MODULE}_VERSION := ${MFSYSMON_VERSION}" >>adm/root.mk
